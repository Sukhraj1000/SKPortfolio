...
import { portfolioProfile, storyChapters, type PortfolioStoryAnchor } from "@/data/portfolio";
import { rememberPortfolioAnchor } from "@/lib/game-mode";
...
export function PortfolioNavbar() {
  const { activeSection, activeIndex, progress, selectSection } = usePortfolioProgress();
      ...
      <header className="pq-header pq-scope" data-portfolio-header>
        <div className="pq-header-inner">
          ...
          <nav className="pq-desktop-nav" aria-label="Primary navigation">
            {storyChapters.slice(1).map((chapter) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => activateChapter(chapter.anchor)}
                >
                      ...
                      return (
                        <SheetClose asChild key={chapter.id}>
                          <Link
                            ...
                            onClick={() => activateChapter(chapter.anchor)}
                          >
                            <span className="text-xs text-signal-cyan">{chapter.index}</span>
                            {chapter.portfolioLabel}
      ...
      {gameLaunching ? (
        ...
        >
          ...
          <div className="pq-game-launch-copy">
            ...
            <span className="pq-game-launch-progress" aria-hidden="true">
              <i />
            </span>
